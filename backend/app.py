...
def home():
    ...
    return jsonify({
        ...
        "message":
            "Healthcare Analytics Flask API is running.",
...
def dashboard():
    ...
    try:
        ...
        illness = request.args.get(
            "illness"
        )

        health_value = request.args.get(
            "health"
        )

        chronic = request.args.get(
            "chronic"
        )

        private = request.args.get(
            "private"
        )

        freepoor = request.args.get(
            "freepoor"
        )

        freerepat = request.args.get(
            "freerepat"
        )

        min_visits = request.args.get(
            "min_visits"
        )

        max_visits = request.args.get(
            "max_visits"
        )
...
if __name__ == "__main__":
    ...
    print()
    print("=" * 60)
    print(" HEALTHCARE ANALYTICS BACKEND")
    print("=" * 60)
    print()
    print(
        "Dataset:",
